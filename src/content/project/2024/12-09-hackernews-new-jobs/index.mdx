...
import LinkWithLabel2 from '../../../../components/LinkWithLabel2.astro';
...
- <LinkWithLabel2 label="Repository" href="https://github.com/nemanjam/hn-new-jobs" title="HackerNews new jobs repository" />
